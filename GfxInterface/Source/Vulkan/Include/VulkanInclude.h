...
MapVulkanStruct(VkSemaphoreTypeCreateInfo,                  VK_STRUCTURE_TYPE_SEMAPHORE_TYPE_CREATE_INFO)
MapVulkanStruct(VkSemaphoreWaitInfo,                        VK_STRUCTURE_TYPE_SEMAPHORE_WAIT_INFO)
...
MapVulkanStruct(VkCommandBufferBeginInfo,                   VK_STRUCTURE_TYPE_COMMAND_BUFFER_BEGIN_INFO)
MapVulkanStruct(VkSubmitInfo,                               VK_STRUCTURE_TYPE_SUBMIT_INFO)
MapVulkanStruct(VkImageMemoryBarrier,                       VK_STRUCTURE_TYPE_IMAGE_MEMORY_BARRIER)
...
namespace GFXI
{
    extern const VkFormat VulkanRenderTargetFormatMapping[];
}
